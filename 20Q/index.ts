...
let ListOfItems: string[] = [ "K2 Mountain", "Mount Everest", "Ravi River", "Indus River", "Pakistan", "Malaysia", "Lahore", "Karachi", "Urdu", "Punjabi"];
console.log("List of items are:", ListOfItems);
